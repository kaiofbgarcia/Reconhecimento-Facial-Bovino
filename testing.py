...
class ImageScore(object):
    ...
    def scores(self):
        ...
        self.img = image_utils.load_img(self.img, target_size=(224, 224))
        self.img = image_utils.img_to_array(self.img)
        self.img = np.expand_dims(self.img, axis=0)
        self.img = utils.preprocess_input(self.img, version=2) # or version=2
        ...
        print('Predições (do maior pro menor):')
        print(preds)
        return preds
